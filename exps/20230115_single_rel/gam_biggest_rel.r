library(mgcv)
df <- read.csv(file='/Users/blackbird/Desktop/professional/PhD_program/ao3/data/fanfic_regression_data_20210915_largest_rel.tsv', header=TRUE, sep='\t')
...
pdf('/Users/blackbird/Desktop/gam_res_merged_20210915_largest_rel.pdf', width=17, height=8)
par(mfrow=c(2,4))
