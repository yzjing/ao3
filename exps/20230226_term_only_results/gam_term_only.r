library(mgcv)
df <- read.csv(file='/Users/blackbird/Desktop/professional/PhD_program/ao3/data/fanfic_regression_data_20211216_term_only_no_crossover.tsv', header=TRUE, sep='\t')


df_kudos <- df[df$Kudos != 0, ]
 res_kudos <- mgcv::bam(Kudos ~ s(Term_novelty, bs='cr', sp=0.1,k=5)
...
df_hits <- df[df$Hits != 0, ]
 res_hits <- mgcv::bam(Hits ~ s(Term_novelty, bs='cr', sp=0.1,k=5)
 	+ s(Chapters, bs='cr', sp=0.1,k=5) + s(author_fic_cnt, bs='cr', sp=0.1,k=5) 
  + Freq_relationship+ Category_F_F + Category_F_M + Category_Gen + Category_M_M
+  Category_Multi + Category_Other + ArchiveWarnings_underage + ArchiveWarnings_death + 
+ ArchiveWarnings_choose_no + ArchiveWarnings_no_apply + ArchiveWarnings_violence + Rating_E                  
...
res_comments <- mgcv::bam(Comments ~ s(Term_novelty, bs='cr', sp=0.1,k=5)
 	+ s(Chapters, bs='cr', sp=0.1,k=5) + s(author_fic_cnt, bs='cr', sp=0.1,k=5) 
 + Freq_relationship + Category_F_F + Category_F_M + Category_Gen + Category_M_M
+  Category_Multi + Category_Other + ArchiveWarnings_underage + ArchiveWarnings_death + 
+ ArchiveWarnings_choose_no + ArchiveWarnings_no_apply + ArchiveWarnings_violence + Rating_E                  
...
df_bookmarks <- df[df$Bookmarks != 0, ]
 res_bookmarks <- mgcv::bam(Hits ~ s(Term_novelty, bs='cr', sp=0.1,k=5)
 	+ s(Chapters, bs='cr', sp=0.1,k=5) + s(author_fic_cnt, bs='cr', sp=0.1,k=5) 
 + Freq_relationship + Category_F_F + Category_F_M + Category_Gen + Category_M_M
+  Category_Multi + Category_Other + ArchiveWarnings_underage + ArchiveWarnings_death + 
+ ArchiveWarnings_choose_no + ArchiveWarnings_no_apply + ArchiveWarnings_violence + Rating_E                  
...
df_kudos_to_hits <- df[df$kudos_hit_ratio != 0, ]
 res_kudos_to_hits <- mgcv::bam(kudos_hit_ratio ~ s(Term_novelty, bs='cr', sp=0.1,k=5)
 	+ s(Chapters, bs='cr', sp=0.1,k=5) + s(author_fic_cnt, bs='cr', sp=0.1,k=5) 
 + Freq_relationship + Category_F_F + Category_F_M + Category_Gen + Category_M_M
+  Category_Multi + Category_Other + ArchiveWarnings_underage + ArchiveWarnings_death + 
+ ArchiveWarnings_choose_no + ArchiveWarnings_no_apply + ArchiveWarnings_violence + Rating_E                  
...
pdf('/Users/blackbird/Desktop/gam_res_merged_term_only_no_crossover_20230423.pdf', width=22, height=4)
...
plot(res_comments, scale=0, shade=TRUE,  select=1, xlab='Term novelty', ylab='Comments', cex.lab=2.1, cex.axis=2.1)
